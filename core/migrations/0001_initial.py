    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.CharField(choices=[('vacation', 'Vacation'), ('sick', 'Sick Leave'), ('training', 'Training'), ('personal', 'Personal Appointment'), ('company_holiday', 'Company Holiday'), ('other', 'Other')], max_length=50)),
                ('notes', models.TextField(blank=True)),
                ('is_recurring', models.BooleanField(default=False)),
                ('recurrence_pattern', models.JSONField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='unavailability_created', to=settings.AUTH_USER_MODEL)),
                ('parent_block', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='occurrences', to='core.unavailability')),
                ('salesman', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='unavailability_blocks', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['salesman'], name='core_unavai_salesma_c933e6_idx'),
        ),
        migrations.AddIndex(
            model_name='unavailability',
            index=models.Index(fields=['start_date'], name='core_unavai_start_d_53b30e_idx'),
        ),
        migrations.AddIndex(
            model_name='unavailability',
            index=models.Index(fields=['salesman', 'start_date', 'end_date'], name='core_unavai_salesma_aaf910_idx'),
        ),
    ]
