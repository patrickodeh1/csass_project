    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_owner', models.CharField(help_text="business owner's full name", max_length=100)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['salesman', 'date', 'appointment_type', 'is_active'], name='core_availa_salesma_2bf4aa_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='client',
